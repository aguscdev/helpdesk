                ...
                <section class="content-header">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">        
                            <form action="l_head_perbaikan.php" method="get">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">            
                            <a target="_blank" href="head_cetak_print_perbaikan.php?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?>" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-print"></i> CETAK</a>
                            <a target="_blank" href="head_cetak_pdf_perbaikan.php?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?>" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-print"></i> CETAK PDF</a>
                            <br/>
                            <br/>
                            <table class="table table-bordered table-striped">
                                ...
                                $data = mysqli_query($koneksi,"SELECT p.*, i.issue AS v_issue, pic.nama AS nama_programmer, us.nama as nama_client
                                    ...
                                    WHERE p.is_active = 1 and p.created_at between ('".$dari."') and ('".$sampai."') ORDER BY id desc");
                                $no = 1;
