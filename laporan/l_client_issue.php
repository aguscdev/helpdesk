                ...
                <section class="content-header">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">        
                            <form action="l_client_issue.php" method="get">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">            
                            <a target="_blank" href="client_cetak_print_issue.php?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?>" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-print"></i> CETAK</a>
                            <a target="_blank" href="client_cetak_pdf_issue.php?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?>" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-print"></i> CETAK PDF</a>
                            <br/>
                            <br/>
