            ...
            <section class="content-header">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a class="btn btn-success" href="../issue/v_add_head_issue.php">Tambah</a><br/><br/>
                            ...
                            <tbody>
                                ...
                                while($d = mysqli_fetch_array($data)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="v_edit_head_issue.php?id=<?php echo $d['id']; ?>" class="btn btn-warning">Edit</a> ||
                                            <a href="action_delete_head_issue.php?id=<?php echo $d['id']; ?>" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php
                                };
