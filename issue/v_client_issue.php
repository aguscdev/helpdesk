                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Master Issue</div>
                                <div class="panel-body">
                                    <a class="btn btn-success" href="../issue/v_add_client_issue.php">Tambah</a><br/><br/>
                                    <table id="dtUser" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $data = mysqli_query($koneksi,"SELECT s.*, u.nama AS nama_client, pic.nama AS nama_programmer FROM tb_issue s
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $d['nama_programmer']; ?></td>
                                                <td>
                                                    <?php 
                                                    if($d['status']=="Pending"){
